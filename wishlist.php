...
$id = $_GET['uid'];
$wishlistsql = "SELECT * FROM ark.wishlist_util WHERE uid = '$id'";
     ...
     <div class="navBar wishlist">
       ...
       <div class="icons">
        ...
        <!-- <span style="float:left;margin:8px;"><a href = "wishlist.php"><img src="img/wishlist.png" style="width:30px;height:30px;margin-left:8px;"/></a></span>-->
         <span style="float:left;margin:8px;"><a href = "account.php?uid=<?php echo $id?>"><img src="img/account.png" style="width:30px;height:30px;margin-left:8px;"/></a></span>
